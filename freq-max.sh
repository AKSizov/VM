...
#echo $FREQ > /sys/devices/system/cpu/cpu8/cpufreq/scaling_max_freq
#echo $FREQ > /sys/devices/system/cpu/cpu9/cpufreq/scaling_max_freq
#echo $FREQ > /sys/devices/system/cpu/cpu10/cpufreq/scaling_max_freq
#echo $FREQ > /sys/devices/system/cpu/cpu11/cpufreq/scaling_max_freq
#echo $FREQ > /sys/devices/system/cpu/cpu12/cpufreq/scaling_max_freq
#echo $FREQ > /sys/devices/system/cpu/cpu13/cpufreq/scaling_max_freq
#echo $FREQ > /sys/devices/system/cpu/cpu14/cpufreq/scaling_max_freq
#echo $FREQ > /sys/devices/system/cpu/cpu15/cpufreq/scaling_max_freq
